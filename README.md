...
This repo contains the sample application for [Building and testing Cloud applications with LocalStack and Docker guide on Docker Docs][def].
...
[def]: https://github.com/ajeetraina/todo-list-localstack-docker